...
WHERE customer_email = 'westfalenamin@gmail.com' 
   ...
   OR customer_email = 'mohamedmichaux91@gmail.com' 
   OR customer_email_actual = 'mohamedmichaux91@gmail.com';

-- Delete all related data for orders from these email addresses
...
SELECT 'Orders and related data for westfalenamin@gmail.com and mohamedmichaux91@gmail.com have been deleted' as result;
