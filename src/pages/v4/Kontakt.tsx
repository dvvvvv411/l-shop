                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="firstname" name="firstname" type="text" value={formData.firstname} onChange={handleChange} className="border-gray-200 focus:border-red-500 h-12" placeholder="Votre prénom" required />
                        </div>
                        <div>
                          <Label htmlFor="lastname" className="text-gray-800 font-medium mb-2 block">
                            Nom *
                          </Label>
                          <Input id="lastname" name="lastname" type="text" value={formData.lastname} onChange={handleChange} className="border-gray-200 focus:border-red-500 h-12" placeholder="Votre nom" required />
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="email" name="email" type="email" value={formData.email} onChange={handleChange} className="border-gray-200 focus:border-red-500 h-12" placeholder="votre@email.fr" required />
                        </div>
                        <div>
                          <Label htmlFor="phone" className="text-gray-800 font-medium mb-2 block">
                            Téléphone
                          </Label>
                          <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} className="border-gray-200 focus:border-red-500 h-12" placeholder="01 23 45 67 89" />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <select id="subject" name="subject" value={formData.subject} onChange={handleChange} className="w-full h-12 px-3 border border-gray-200 rounded-md focus:border-red-500 focus:ring-red-500" required>
                      ...
                      <div>
                        ...
                        <Textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={5} className="border-gray-200 focus:border-red-500 resize-none" placeholder="Décrivez votre demande en détail..." required />
                      </div>
                      
                      <div className="flex items-start space-x-3">
                        <input type="checkbox" id="consent" name="consent" checked={formData.consent} onChange={handleChange} className="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500 mt-0.5" required />
                      ...
                      <Button type="submit" className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white h-12 text-lg font-medium">
          ...
          delay: 0.6
            ...
            <Card className="shadow-xl border-0">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-gray-600">
                  <p className="font-medium">95 rue Compans</p>
            ...
            <Card className="shadow-xl border-0 bg-gradient-to-br from-red-600 to-red-700 text-white">
              <CardContent className="p-8">
                ...
                <Button asChild className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 border-0 font-medium">
