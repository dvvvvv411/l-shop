        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (STANTON GmbH, Schellingstr. 109 a, 80798 München, E-Mail: info@stanton-energie.de) mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren.</p>
            </section>
