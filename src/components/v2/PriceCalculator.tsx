...
const PriceCalculator = () => {
  ...
  const savings = deliveryFee === 0 ? 25 : 0;
    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">
          Ihr Heizöl-Preis in <span className="text-blue-600">60 Sekunden</span>
        </h2>
          ...
          >
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <label className="text-sm font-semibold text-gray-700">
                    Menge: {amount.toLocaleString('de-DE')}L
                  </label>
                </div>
                <div className="relative">
                  <input
            ...
            <div className="mt-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <label className="text-sm font-semibold text-gray-700">Produkt wählen</label>
              </div>
                        ...
                        <Label htmlFor={product.id} className="cursor-pointer">
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-xs text-gray-500">pro L</div>
                            </div>
                          </div>
                        </Label>
                      </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-600">Grundpreis ({amount.toLocaleString('de-DE')}L)</span>
