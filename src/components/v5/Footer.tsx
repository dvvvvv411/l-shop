  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-green-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-orange-600/20 rounded-full blur-2xl"></div>
      </div>
          ...
          <div className="lg:col-span-1">
            <Link to={getUrl('/')} className="flex items-center mb-6">
              {logoConfig.footerImageUrl ? (
                ...
                <div className="bg-gradient-to-br from-green-600 to-green-700 text-white p-3 rounded-xl">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">info@gasolio-express.it</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-semibold">Gasolio Express Italia Srl</p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2025 Gasolio Express Italia Srl. Tutti i diritti riservati.
            </div>
