...
const products: Product[] = [
  {
    ...
    price: 0.75,
    description: 'Gasolio domestico certificato normas italiane',
    badge: 'Popolare'
  },
  {
    id: 'premium',
    ...
    price: 0.80,
    description: 'Gasolio domestico alta qualità con additivi',
    badge: 'Consigliato'
  }
];
...
const PriceCalculator = () => {
  ...
  const savings = deliveryFee === 0 ? 45 : 0;
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      >
        <div className="inline-flex items-center bg-gradient-to-r from-green-50 to-orange-50 border border-green-200 text-green-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
          <Zap size={16} className="mr-2" />
          Calcolo istantaneo • Prezzi garantiti competitivi
        </div>
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">
          Il tuo prezzo gasolio in <span className="text-green-600">60 secondi</span>
        </h2>
        <p className="text-gray-600 text-lg">
          Trasparente • Veloce • Affidabile
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Codice Postale Input */}
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <span className="text-green-600 font-bold text-xs">1</span>
                  </div>
                  <label className="text-sm font-semibold text-gray-700">Codice postale</label>
                </div>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-green-500 text-lg font-semibold transition-all ${
                ...
                {!isValidPostcode && postcode.length === 5 && (
                  ...
                  >
                    Codice postale valido richiesto
                  </motion.p>
                )}
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <label className="text-sm font-semibold text-gray-700">
                    Quantità: {amount.toLocaleString('it-IT')}L
                  </label>
                </div>
                <div className="relative">
                  <input
            ...
            <div className="mt-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <label className="text-sm font-semibold text-gray-700">Scegli il prodotto</label>
              </div>
              <RadioGroup value={selectedProduct} onValueChange={setSelectedProduct}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {products.map((product) => (
                    ...
                    >
                      {product.badge && (
                        <div className="absolute -top-2 -right-2 bg-gradient-to-r from-green-500 to-orange-500 text-white text-xs px-2 py-1 rounded-full font-bold">
                          {product.badge}
                        </div>
                      )}
        ...
        <div className="lg:sticky lg:top-6 lg:h-fit">
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-50 to-green-50 rounded-2xl border border-green-100 overflow-hidden"
          >
            {/* Price Header */}
            <div className="bg-gradient-to-r from-green-600 to-orange-600 text-white p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Calculator size={20} />
                  <span className="font-semibold">Il tuo prezzo</span>
                </div>
                {savings > 0 && (
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-600">Prezzo base ({amount.toLocaleString('it-IT')}L)</span>
                ...
                <div className="flex justify-between items-center text-sm">
                  {deliveryFee > 0 ? (
                    ...
                    <>
                      <span className="text-green-600 font-medium">Consegna gratuita</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold text-gray-900">Prezzo totale</span>
              ...
              <div className="space-y-2 pt-2">
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>Qualità certificata italiana</span>
                </div>
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>Prezzi garantiti competitivi</span>
                </div>
              </div>
              ...
              <motion.button
                ...
                className={`w-full py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center space-x-2 ${
                  isFormValid
                    ? 'bg-gradient-to-r from-green-600 to-orange-600 text-white hover:from-green-700 hover:to-orange-700 shadow-lg hover:shadow-xl'
                    : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                }`}
              >
                <span>{isFormValid ? 'Ordina ora' : 'Completa i campi'}</span>
              ...
              {isFormValid && (
                ...
                >
                  <div className="bg-gradient-to-r from-orange-100 to-green-100 border border-orange-200 text-orange-700 px-3 py-2 rounded-lg text-sm font-medium">
                    <div className="flex items-center justify-center space-x-1">
                      <TrendingDown size={16} />
                      <span>Prezzi attuali del mercato • Prenota ora</span>
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              {deliveryFee === 0 && (
                ...
                >
                  <div className="inline-flex items-center space-x-2 bg-green-100 text-green-700 px-3 py-2 rounded-full text-sm font-medium">
                    <CheckCircle size={16} />
                    <span>Consegna gratuita sbloccata!</span>
                  </div>
                </motion.div>
              )}
            </div>
