...
const WhyChooseUs = () => {
  ...
  return <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-gray-100 overflow-hidden">
          ...
          duration: 1
            ...
            <div className="relative bg-gradient-to-br from-white to-blue-50/50 rounded-3xl p-8 shadow-2xl border border-white/50 backdrop-blur-sm">
              ...
              <div className="flex justify-center space-x-2 mt-6">
                {features.map((_, index) => <button key={index} onClick={() => setActiveFeature(index)} className={`w-3 h-3 rounded-full transition-all duration-300 ${index === activeFeature ? 'bg-red-600 scale-125' : 'bg-gray-300 hover:bg-gray-400'}`} />)}
              </div>
            </div>
          ...
          duration: 1
            ...
            <div className="mb-12">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Pourquoi choisir{' '}
                <span className="bg-gradient-to-r from-red-600 to-blue-600 bg-clip-text text-transparent">Fioul Rapide</span>
                ?
              </h2>
            ...
            <div className="space-y-4">
              ...
              return <motion.div key={index} initial={{
                ...
                duration: 0.6,
                delay: index * 0.1
              }} onMouseEnter={() => setActiveFeature(index)} className={`group cursor-pointer bg-white/80 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 hover:shadow-xl hover:scale-105 ${activeFeature === index ? 'border-red-300 shadow-lg bg-gradient-to-r from-white to-red-50/50' : 'border-gray-200 hover:border-gray-300'}`}>
                    <div className="flex items-start space-x-4">
                      ...
                      <ArrowRight className={`h-5 w-5 text-gray-400 transition-all duration-300 ${activeFeature === index ? 'text-red-600 translate-x-1' : 'group-hover:text-gray-600'}`} />
                    </div>
                  </motion.div>;
            })}
            </div>
            ...
            delay: 0.8
              ...
              <motion.a href="#calculator" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
