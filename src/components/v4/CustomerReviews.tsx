...
const CustomerReviews = () => {
  ...
  return <section className="py-20 bg-gradient-to-br from-red-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        once: true
          ...
          {reviews.map((review, index) => <motion.div key={index} variants={itemVariants} className="group">
        ...
        delay: 0.4
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mb-6 text-lg">Faites confiance à l'expertise française de Fioul Rapide pour votre approvisionnement en fioul domestique.</p>
            <motion.button onClick={scrollToCalculator} whileHover={{
            scale: 1.05
          }} whileTap={{
            scale: 0.95
