...
const Header = () => {
  ...
  return (
    <header className="relative bg-gradient-to-r from-blue-800 via-white to-red-600 shadow-xl">
      {/* Malta flag stripe */}
      <div className="h-1 bg-gradient-to-r from-gray-400 via-white to-gray-400"></div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-2 text-gray-600">
                <Mail size={16} />
                <span className="text-sm font-medium">info@maltaheat.com</span>
              </div>
            </div>
            ...
            <button
              onClick={toggleMenu}
              className="md:hidden z-50 relative p-2 text-gray-700 hover:text-blue-600 transition-colors"
            >
