  ...
  const steps = [
    {
      ...
      description: "Geben Sie Ihre Postleitzahl und gewünschte Menge ein. Unser Rechner zeigt Ihnen sofort den aktuellen Bestpreis an."
    },
    {
      step: 2,
      icon: MapPin,
      title: "Bestellung aufgeben",
      description: "Wählen Sie Ihren Wunschliefertermin aus den verfügbaren Lieferzeitfenstern in Ihrer Region."
    },
    {
      step: 3,
      icon: CheckCircle,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Zu Ihrem günstigen Heizöl in nur 4 einfachen Schritten - schnell, sicher und unkompliziert
          </p>
        </motion.div>
