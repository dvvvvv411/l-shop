...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Wählen Sie Ihren Wunschliefertermin aus den verfügbaren Lieferslots in Ihrer Region."
    },
    {
      step: 3,
      icon: CheckCircle,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ihr günstiges Heizöl in nur 4 einfachen Schritten - schnell, sicher und unkompliziert
          </p>
        </motion.div>
