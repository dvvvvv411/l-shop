  ...
  const reasons = [
    {
      ...
      description: "Wir garantieren Ihnen die besten Preise am Markt. Sollten Sie anderswo günstiger finden, gleichen wir den Preis an."
    },
    {
      icon: Truck,
    ...
    },
    {
      ...
      description: "Alle unsere Heizölsorten entsprechen der DIN EN 590 Norm und werden regelmäßig von unabhängigen Laboren geprüft."
    },
    {
      icon: Phone,
    ...
    },
    {
      ...
      description: "Seit über 15 Jahren sind wir Ihr zuverlässiger Partner für Heizöllieferungen in ganz Deutschland."
    },
    {
      icon: Clock,
