  ...
  const reasons = [
    {
      ...
      description: "Wir garantieren Ihnen die besten Preise am Markt. Sollten Sie anderswo günstiger finden, gleichen wir den Preis aus."
    },
    {
      icon: Truck,
    ...
    },
    {
      ...
      description: "Alle unsere Heizölsorten entsprechen den EN 590 Standards und werden regelmäßig von unabhängigen Laboren geprüft."
    },
    {
      icon: Phone,
    ...
    },
    {
      ...
      description: "Seit über 25 Jahren sind wir Ihr zuverlässiger Partner für Heizöllieferungen in ganz Deutschland."
    },
    {
      icon: Clock,
      title: "Flexible Termine",
      description: "Wählen Sie Ihren Wunschliefertermin. Auch kurzfristige Termine sind meist möglich."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Entdecken Sie die Vorteile, die uns zu Deutschlands führendem Heizöl-Lieferanten machen
          </p>
        </motion.div>
