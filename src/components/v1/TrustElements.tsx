...
const trustElements = [
  ...
  },
  {
    ...
    description: "DIN EN 590 zertifiziertes Premium-Heizöl nach höchsten Standards",
  ...
  },
  {
    ...
    description: "Lieferung in alle Postleitzahlengebiete in Deutschland",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Über 15 Jahre Erfahrung im Heizölhandel - Ihre Zufriedenheit ist unser Erfolg
          </p>
        </motion.div>
