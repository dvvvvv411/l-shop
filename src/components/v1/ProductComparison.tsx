  ...
  const products = [
    {
      ...
      popular: false,
      features: [
        { text: "DIN EN 590 Qualitätsstandard", included: true },
        { text: "Standard-Schwefelgehalt", included: true },
        { text: "Basis-Additive", included: true },
        { text: "Premium-Additive", included: false },
        { text: "Verlängerte Lagerfähigkeit", included: false },
        { text: "Optimierter Heizwert", included: false }
      ]
    },
    {
      name: "Premium Heizöl",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Wählen Sie das perfekte Heizöl für Ihre Bedürfnisse - von bewährter Standardqualität bis zu Premium-Performance
          </p>
        </motion.div>
