...
const translations = {
  ...
  nl: {
    ...
    termsSection: {
      ...
      acceptTermsText: 'Ik accepteer de Algemene Voorwaarden en het Herroepingsrecht. Ik ben ervan bewust dat ik mijn herroepingsrecht verlies bij een bestelling van mazout zodra de levering is begonnen. *',
      submitButton: 'Betalingsplichtig bestellen',
      submittingButton: 'Bestelling wordt aangemaakt...'
    },
    summary: {
      orderSummary: 'Bestelsamenvating',
      ...
      freeShippingNote: 'Gratis levering vanaf 2.000 liter',
      sslEncrypted: 'SSL versleuteld',
      securePayment: 'Veilige betaling',
      timelyDelivery: 'Stipte levering',
    ...
    confirmation: {
      ...
      orderSuccess: 'Uw bestelling is succesvol geplaatst!',
      paymentInstructions: 'Betalingsinstructies',
      howToPay: 'Zo betaalt u uw bestelling',
      nextSteps: 'Volgende stappen',
      phoneContact: '1. Bestellingcontrole',
      phoneContactDesc: 'Uw bestelling wordt gecontroleerd en u ontvangt de bankinformatie.',
      bankTransfer: '2. Overschrijving',
      bankTransferDesc: 'Na ontvangst van de bankinformatie maakt u het bedrag van {amount}€ over.',
      delivery: '3. Levering',
      deliveryDesc: 'Na betalingsbevestiging volgt levering binnen 2-4 werkdagen.',
      deliveryInformation: 'Leveringsinformatie',
      deliveryDetails: 'Belangrijke details over uw levering',
      ...
      bankAccountTitle: 'Bankverbinding voor betaling',
    ...
    system: {
      ...
      testDataDescription: 'Het formulier is gevuld met willekeurige testgegevens.',
      emailSendTitle: 'E-mail verzending',
      emailSendDescription: 'De orderbevestiging kon niet worden verzonden. U ontvangt deze binnenkort.',
      errorTitle: 'Fout',
